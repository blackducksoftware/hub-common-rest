...
class OauthRestConnectionValidatorTest {
    ...
    public void testTokenManagerValid() {
        ...
        String resultString = result.getResultString(OauthRestConnectionFieldEnum.TOKENMANAGER)
    ...
    public void testAccessTypeValid() {
        ...
        String resultString = result.getResultString(OauthRestConnectionFieldEnum.ACCESSTYPE)
    ...
    public void testBaseUrlValid() {
        ...
        String resultString = result.getResultString(RestConnectionFieldEnum.URL)
    ...
    public void testLoggerValid() {
        ...
        String resultString = result.getResultString(RestConnectionFieldEnum.LOGGER)
    ...
    public void testTimeoutValid() {
        ...
        String resultString = result.getResultString(RestConnectionFieldEnum.TIMEOUT)
    ...
    public void testHeadersValid() {
        ...
        String resultString = result.getResultString(RestConnectionFieldEnum.COMMON_HEADERS)
